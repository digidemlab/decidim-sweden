...
DECIDIM_VERSION = { git: "https://github.com/mainio/decidim", branch: "feature/multibudget-maximum-votes" }
...
gem "decidim-navbar_links", git: "https://github.com/OpenSourcePolitics/decidim-module-navbar_links", ref: "0.23-stable"
...
group :production do
  ...
  gem "sinatra"
  gem "decidim-antivirus", git: "https://github.com/mainio/decidim-module-antivirus", branch: "develop"
end
