    ...
    module Concerns
      ...
      module HasQuestionnaire
        ...
        included do
          ...
          helper_method :questionnaire_for, :questionnaire, :allow_answers?, :visitor_can_answer?,
                        :visitor_already_answered?, :update_url, :form_path
          ...
          def session_token
            ...
            @session_token ||= (tokenize(id || session_id).to_i * 1000000 + Random.rand(1000000)).to_s
          end
